...
public class PanelBrand extends javax.swing.JPanel {
    ...
    public PanelBrand() {
        ...
        //PlaceHolder
        txtSearch.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "ຄົ້ນຫາຂໍ້ມູນຍີ່ຫໍ້");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ຈັດການຂໍ້ມູນຍີ່ຫໍ້", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lao_SomVang", 0, 16))); // NOI18N
        ...
        jPanel1.add(txtBrand_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 350, -1));
        ...
        jPanel1.add(txtBrand_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 76, 350, -1));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (txtBrand_name.getText().isBlank()) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtBrand_id.setText(d.getValueAt(rowIndex, 1).toString());
        txtBrand_name.setText(d.getValueAt(rowIndex, 2).toString());
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        try {
            String sql = " SELECT *FROM brand  WHERE  CONCAT(brand_id,  brand_name) LIKE  ? ORDER BY brand_id DESC ";
            pst = conn.prepareStatement(sql);
